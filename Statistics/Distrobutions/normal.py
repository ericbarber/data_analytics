...
def make_plot(title, hist, edges, x, pdf, cdf):
    ...
    p.line(x, pdf, line_color="#ff8888", line_width=4, line_alpha=0.7, name="PDF")
    p.line(x, cdf, line_color="orange", line_width=2, line_alpha=0.7, name="CDF")
...
# make_plot(title, hist, edges, x, pdf, cdf)
